package com.spotify.tests;//package com.spotify.tests;
...
public class PlaylistTestsUsingJsonData extends TestHook {
    ...
    @Test(description = "Create a Playlist with valid details",
          dataProvider = "jsonPlaylistRequestPayload",
          dataProviderClass = PlaylistDataProvider.class)
    public void shouldBeAbleToCreateAPlaylistWithJsonData(Playlist playlistRequestPayload) throws IOException {
